...
unsigned char ds1302_get_time(struct ymdhms_t *ATime);              //gets the time, returns 0 if clock is not set
void ds1302_set_time(struct ymdhms_t *ATime);                       //sets the time
